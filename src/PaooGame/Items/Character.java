...
//        int xAss = (int) x + (int) (xMove +  bounds.x);
//        int yAss = (int) y + (int) (yMove + bounds.y);
//        if(CanMoveHere((int) xAss,(int) yAss,(int)bounds.getWidth()-3 ,(int)bounds.getHeight()-3,refLink))
//        {
//            x=xAss-bounds.x;
//            y=yAss- bounds.y;
//        }
    ...
    public void MoveX()
    {
        ...
        //if(CanMoveHere((int)(x+bounds.x+xMove),(int)(y+ bounds.y+yMove), (int)bounds.getWidth(),(int)bounds.getHeight(),refLink))
        if(CanMoveHere((int)(x+visualBounds.x+xMove),(int)(y+ visualBounds.y+yMove), (int)visualBounds.getWidth(),(int)visualBounds.getHeight(),refLink,(int)(x+xMove),(int)(y+yMove)))
                 x+=xMove;
    ...
    public boolean IntersectsEnemy() {
