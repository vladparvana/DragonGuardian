...
public class Warrior extends Enemy{
     ...
     */
    public Warrior(RefLinks refLink, float x, float y)
    {
    ...
    private void InitAnimations() {
        ...
        SpriteSheet spriteSheet= new SpriteSheet(ImageLoader.LoadImage("/Warrior.png"));
        for(int x=0;x<4;x++)
            for(int y=0;y<4;y++)
            {
        ...
        spriteSheet= new SpriteSheet(ImageLoader.LoadImage("/Warrior_Attack.png"));
        for(int x=0;x<4;x++)
            for(int y=0;y<4;y++)
            {
