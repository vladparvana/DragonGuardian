...
public class PoisonPotion extends Object{

    private BufferedImage image;
    public PoisonPotion(RefLinks refLinks, int x, int y) {
        super(refLinks,x,y,OBJECT_WIDTH,OBJECT_HEIGHT,2);
        SpriteSheet spriteSheet= new SpriteSheet(ImageLoader.LoadImage("/poisonpotion.png"));
